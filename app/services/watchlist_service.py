...
def search_public_watchlists_by_name(
    ...
    return watchlist_crud.list_public_by_name(session, name=name, limit=limit, offset=offset)

def load_items_for_watchlists(session: Session, watchlist_ids: List[int]) -> Dict[int, List[WatchlistItem]]:
    ...
    stmt = (
        ...
        .order_by(WatchlistItem.watchlist_id.asc(),
