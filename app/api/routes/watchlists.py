...
from app.services.watchlist_service import load_items_for_watchlists, search_public_watchlists_by_name
...
def get_watchlists_by_name(
    ...
    watchlists = search_public_watchlists_by_name(db, name=name, limit=limit, offset=offset)
    if not watchlists:
        return []
